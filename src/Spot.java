...
public interface Spot {
	...
	default boolean sameColor(Spot other) {
		if (other == null) throw new IllegalArgumentException("Other spot cannot be null.");
		
		if (getSpotColor().equals(other.getSpotColor()) && !isEmpty() && !other.isEmpty()) {
			return true;
		}
		return false;
	}
